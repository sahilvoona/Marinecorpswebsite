...
<head>
  ...
  <title>Past Commandants - MCLWHD</title>
...
<<<<<<< HEAD:commandants.html
                        ...
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <h4>Perry Piwowarski</h4>
                            <p>2000 – 2002</p>
                        </div>
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <h4>Bill McDonough</h4>
                            <p>1999 – 2000</p>
                        </div>
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <h4>Ronald T. Leminielle</h4>
                            <p>1997 – 1999</p>
                        </div>
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <h4>Bill Gfroehrer</h4>
                            <p>1996 – 1997</p>
                        </div>
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <h4>Rocky Greco</h4>
                        ...
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <h4>Gabriel Viggiani</h4>
                            <p>1991 – 1993</p>
                        </div>
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <h4>Murray J. Sklar</h4>
                            <p>1997 – 1999</p>
                        </div>
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <h4>Robert A. McGuinness</h4>
                            <p>1990 – 1991</p>
                        </div>
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <h4>Roddy MacDonald</h4>
                            <p>1986 – 1988</p>
                        </div>
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <h4>Esse Davis</h4>
